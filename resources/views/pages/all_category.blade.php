					...
					<div class="shop_sidebar">
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li><a href="{{ url('catalog/'.$row->id) }}">{{ $row->category_name}}</a></li>
								@endforeach
							</ul>
						</div>
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count" style="margin-top:10px;"><span>@php echo count($products); @endphp</span> products found</div>
