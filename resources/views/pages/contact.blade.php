				...
				<div class="col-lg-10 offset-lg-1">
					<div class="contact_form_container">
						...
						@csrf
							...
							<input type="email" id="contact_form_email" class="contact_form_email input_field" placeholder="Your email" 
									required="required" data-error="Email is required." name="email">
