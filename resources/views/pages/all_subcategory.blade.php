					...
					<div class="shop_sidebar">
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li><a href="{{ url('allsubcategory/'.$row->id) }}">{{ $row->subcategory_name}}</a></li>
								@endforeach
							</ul>
						</div>
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count"><span>@php echo count($products); @endphp</span> products found</div>
							<div class="shop_sorting">
								<span>Price:</span>
								<select class="custom-select" id="price_select" style="width:100px">
									<option value="asc" selected>Low</option>
									<option value="desc">High</option>
								</select>
							</div>
						</div>

						<div class="product_grid row" id="product_list">
							<!-- <div class="product_grid_border"></div> -->

							<!-- Product Item -->
                            @include('pages.product_list')
						</div>
...
@section('js')
	<script	script src="{{ asset('public/frontend/js/custom.js')}}"></script>
	<script type="text/javascript">
		$('#price_select').change(function(){

			let order = $('#price_select').val();
