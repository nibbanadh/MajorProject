                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="post_title_en" placeholder="Post Title in English" required>
                            </div>
                        </div><!-- col-6 -->
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label">Post Title (Nepali): <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="post_title_nep" placeholder="Post Title in Nepali" required>
                            </div>
                        </div><!-- col-6 -->
