            ...
            <form method="post" action="{{route('update.admin')}}">
                ...
                <div class="form-layout">
                    <div class="row mg-b-25">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="User Name" value="{{$user->name}}" required>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="form-control-label">Phone: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="phone" placeholder="Phone" value="{{$user->phone}}" required>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <label class="ckbox">
                                <input type="checkbox" name="vendor" value="1" <?php if($user->vendor==1)echo "checked" ?>>
                                <span>Vendor</span>
                            </label>
